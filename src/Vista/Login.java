            ...
            if (hash == true && func.totalRegistros > 0) {
                ...
                switch (lblPermisos.getText()) { //Se extraen los Permisos del usuario para saber que Frame le será habilitado
                    case "Administrador": {
                        ...
                        Principal.lblCodigo.setText(tablalistado.getValueAt(0, 0).toString());
                        Principal.lblUsuario.setText(tablalistado.getValueAt(0, 1).toString());
                        Principal.lblPermisos.setText(tablalistado.getValueAt(0, 9).toString());
                        break;
                    }
                    case "Cajero": {
                        dispose();
                        ...
                        Principal.mnuProductos.setEnabled(false);
                        Principal.mnuProveedores.setEnabled(false);
                        Principal.smnuUsuarios.setEnabled(false);
                        Principal.mnuHerramientas.setEnabled(false);
