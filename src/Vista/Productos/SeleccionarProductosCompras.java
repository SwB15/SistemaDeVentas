 ...
 * @author SwichBlade15
 */
public final class SeleccionarProductosCompras extends javax.swing.JDialog {
    ...
    boolean tecla = false;
    String id, codigo, productos, precio, cantidad, descuento, sSQL, prov;
    int seleccionar;

    public SeleccionarProductosCompras(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void mostrar(String buscar) {
        try {
            ...
            modelo = funcion.seleccionarProductosCompra(buscar);
    ...
    private void tblSeleccionarProductosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSeleccionarProductosMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            Compras.txtIdproductos.setText(String.valueOf(tblSeleccionarProductos.getValueAt(seleccionar, 0)));
            Compras.txtCodigoProductos.setText(String.valueOf(tblSeleccionarProductos.getValueAt(seleccionar, 1)));
            Compras.txtProductos.setText(String.valueOf(tblSeleccionarProductos.getValueAt(seleccionar, 2)));
            Compras.txtPrecioVenta.setText(String.valueOf(tblSeleccionarProductos.getValueAt(seleccionar, 3)));
            Compras.txtPrecioCompra.setEditable(true);
            Compras.txtPrecioCompra.requestFocus();
            Compras.btnAgregarProducto.setEnabled(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionarProductosCompras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SeleccionarProductosCompras dialog = new SeleccionarProductosCompras(new javax.swing.JFrame(), true);
