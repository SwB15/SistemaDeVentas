...
public class Notificaciones extends javax.swing.JInternalFrame {
    ...
    private final Connection cn = mysql.getConnection();
...
//        });
    ...
    public void notificaciones() {
        ...
        if (Principal.tblNotificaciones.getRowCount() > 0) {
            System.out.println(Principal.tblNotificaciones.getRowCount());
            System.out.println("Entro if");
            for (i = 0; i < Principal.tblNotificaciones.getRowCount(); i++) {
                ...
                JLabel datos = new JLabel(String.valueOf(Principal.tblNotificaciones.getValueAt(i, 1))+ " " + String.valueOf(Principal.tblNotificaciones.getValueAt(i, 2)), indice);
