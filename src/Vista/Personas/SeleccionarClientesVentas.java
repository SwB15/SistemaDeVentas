 ...
 * @author SwichBlade15
 */
public final class SeleccionarClientesVentas extends javax.swing.JDialog {
    
    FuncionesClientes funcion = new FuncionesClientes();
    boolean tecla = false;

    public SeleccionarClientesVentas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void mostrar(String buscar) {
        try {
            ...
            modelo = funcion.seleccionarClientesConDescuentos(buscar);
    ...
    private void txtBuscarFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtBuscarFocusLost
        if (tecla == false) {
            txtBuscar.setText("Busque un Cliente...");
        }
    ...
    private void txtBuscarKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyTyped
        ...
        if (Character.isDigit(validar)) {
            getToolkit().beep();
            evt.consume();
            mensaje = "Ingrese solo el NOMBRE del cliente";
            advertencia();
        }
    ...
    private void tblSeleccionarClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSeleccionarClientesMouseClicked
        ...
        if(evt.getClickCount()==2){
            Ventas1.txtIdcliente.setText(String.valueOf(tblSeleccionarClientes.getValueAt(seleccionar, 0)));
            Ventas1.txtNombre.setText(String.valueOf(tblSeleccionarClientes.getValueAt(seleccionar, 1)));
            Ventas1.txtCedula.setText(String.valueOf(tblSeleccionarClientes.getValueAt(seleccionar, 2)));
            Ventas1.txtDescuentoClientes.setText(String.valueOf(tblSeleccionarClientes.getValueAt(seleccionar, 3)));
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionarClientesVentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SeleccionarClientesVentas dialog = new SeleccionarClientesVentas(new javax.swing.JFrame(), true);
